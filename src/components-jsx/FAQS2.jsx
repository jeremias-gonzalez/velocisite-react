    ...
    <div className="hs-accordion-group">
      ...
      <div className="hs-accordion hs-accordion-active:border-gray-200 active bg-white rounded-xl dark:hs-accordion-active:border-neutral-700 dark:bg-neutral-800 dark:border-transparent" id="hs-active-bordered-heading-two">
        ...
        <div id="hs-basic-active-bordered-collapse-two" className="hs-accordion-content w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-active-bordered-heading-two">
          <div className="pb-4 px-5">
            <p className="text-gray-800 poppins-medium p-3 text-sm dark:text-neutral-200">
              Si vendes productos o servicios y deseas expandir tu alcance a una audiencia más amplia,
              ...
              y recomendar la mejor solución.
            </p>
          </div>
        </div>
      </div>
        ...
        <div id="hs-basic-active-bordered-collapse-three" className="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-active-bordered-heading-three">
          <div className="pb-4 px-5">
            <p className="text-gray-800 poppins-medium p-3 text-sm dark:text-neutral-200">
              ...
              incluyendo frameworks como React Js, Next JS, y Tailwind CSS.
      ...
      <div className="hs-accordion hs-accordion-active:border-gray-200 bg-white rounded-xl dark:hs-accordion-active:border-neutral-700 dark:bg-neutral-800 dark:border-transparent" id="hs-active-bordered-heading-four">
        ...
        <div id="hs-basic-active-bordered-collapse-four" className="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-active-bordered-heading-four">
          <div className="pb-4 px-5">
            <p className="text-gray-800 poppins-medium p-3 text-sm dark:text-neutral-200">
